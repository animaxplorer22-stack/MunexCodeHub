...
class MobileMiner:
    ...
    async def _wait_for_knowledge_ack(self):
        # This is a placeholder – we'll handle it via handle_message
        # We'll set a future in handle_message when knowledge_ack arrives
    ...
    async def navigate(self):
        ...
        while self.round_active and pos != self.goal and time.time() < self.deadline:
            ...
            try:
                ...
                print(f"{RED}[Step {step:03d}] TIMEOUT (no ack){RESET}")
