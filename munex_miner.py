...
class MobileMiner:
    def __init__(self, wallet=None, privkey=None, miner_id=None, node_url=None):
        ...
        self._knowledge_submitted = False
    ...
    async def submit_knowledge(self):
        ...
        try:
            ...
            self._knowledge_submitted = True
        except Exception as e:
    ...
    async def navigate(self):
        ...
        while self.round_active and pos != self.goal and time.time() < self.deadline:
            ...
            # ─── Ensure knowledge is submitted before any move ───
            if not self._knowledge_submitted:
            ...
            try:
                ...
                if success:
                    ...
                    # After a successful move, submit fresh knowledge
                    await self.submit_knowledge()
                else:
    ...
    async def handle_message(self, data):
        ...
        if msg_type == "maze_init":
            ...
            if not data.get("accepted"):
                logger.warning("Knowledge rejected by node")
            else:
                self._knowledge_submitted = True
